...
/***/ "./resources/common/js/generated/i18n-messages.js":
/*!********************************************************!*\
  !*** ./resources/common/js/generated/i18n-messages.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  "en": {
      ...
      "setting": {
        ...
        "form": {
          "contacts": {
            ...
            "email": "Email",
            "contact_email": "Email",
            "iframe_map": "Link to map with iframe",
            "phone": "Phone"
          },
          "seo": {
            "title": "Seo settings",
            "seo_title": "The title in the browser tab",
            "seo_meta": "Meta description",
            "seo_keywords": "Keywords",
            "seo_image": "Picture for social networks"
          },
          "code_insert": {
            "title": "Insert code"
          }
    ...
    "validation": {
      ...
      "attributes": {
        "user_info.social_security_number": "Social security number",
        "user_info.driver_license_number": "Driver license number",
        "user_info.driver_license_state": "Driver license state",
        "user_info.address1": "Address 1",
        "user_info.address2": "Address 2",
        "user_info.zip_code": "Zip code",
        "user_info.country": "Country",
        "user_info.state": "State",
        "user_info.city": "City",
        "user_info.work_phone": "Work phone",
        "user_info.date_of_birth": "Date of birth",
        "documents.*": "Document"
      }
    }
  }
...
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./i18n */ "./resources/common/js/utils/i18n.js");

 // todo: translations

var swalConfig = function swalConfig(data) {
  return {
    title: _i18n__WEBPACK_IMPORTED_MODULE_1__["default"].t('common.phrase.confirm.title') || 'Are you sure?',
    text: _i18n__WEBPACK_IMPORTED_MODULE_1__["default"].t('common.phrase.confirm.body') || 'You will not be able to recover this',
    icon: data.type || 'warning',
    buttons: [_i18n__WEBPACK_IMPORTED_MODULE_1__["default"].t('common.word.cancel') || 'Cancel', _i18n__WEBPACK_IMPORTED_MODULE_1__["default"].t('common.word.confirm') || 'Yes, proceed!']
  };
};

var confirmation = {};

confirmation["delete"] = function (success) {
  ...
  sweetalert__WEBPACK_IMPORTED_MODULE_0___default()(swalConfig(data)).then(function (result) {
    if (result) {
      success();
    }
  });
...
confirmation.warning = function (success) {
  var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  sweetalert__WEBPACK_IMPORTED_MODULE_0___default()(swalConfig(data)).then(function (result) {
    if (result) {
      success();
...
/***/ "./resources/common/js/utils/i18n.js":
/*!*******************************************!*\
  !*** ./resources/common/js/utils/i18n.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _generated_i18n_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../generated/i18n-messages */ "./resources/common/js/generated/i18n-messages.js");
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_i18n__WEBPACK_IMPORTED_MODULE_1__["default"]({
  locale: locale,
  messages: _generated_i18n_messages__WEBPACK_IMPORTED_MODULE_2__["default"]
}));
...
__webpack_require__(/*! jgrowl/jquery.jgrowl.min */ "./node_modules/jgrowl/jquery.jgrowl.min.js");
...
notify.info = function (message) {
  var header = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Info';
  $.jGrowl(message, {
    header: header,
    theme: 'bg-primary'
  });
...
notify.success = function (message) {
  var header = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Success';
  $.jGrowl(message, {
    header: header,
    theme: 'bg-success'
  });
...
notify.warning = function (message) {
  var header = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Warning!';
  $.jGrowl(message, {
    header: header,
    theme: 'bg-warning'
  });
...
notify.showErrors = function (errors) {
  if (!errors.response) {
    return;
  }
  /**
  ...
  if (errors.response.data.errors) {
    Object.keys(errors.response.data.errors).forEach(function (key) {
      var _iterator = _createForOfIteratorHelper(errors.response.data.errors[key]),
          _step;
  ...
  if (errors.response.data.message) {
    if (isString(errors.response.data.message)) {
      ...
      Object.keys(errors.response.data.message).forEach(function (key) {
        var _iterator2 = _createForOfIteratorHelper(errors.response.data.message[key]),
            _step2;
  ...
  var _iterator3 = _createForOfIteratorHelper(errors.response.data),
      _step3;
...
/***/ 1:
/*!***********************************************************************************************!*\
  !*** multi ./resources/common/js/utils/notify.js ./resources/common/js/utils/confirmation.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /app/resources/common/js/utils/notify.js */"./resources/common/js/utils/notify.js");
module.exports = __webpack_require__(/*! /app/resources/common/js/utils/confirmation.js */"./resources/common/js/utils/confirmation.js");
