        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col col-auto">
                    <a :href="$r('admin.faq.create')" class="btn btn-labeled btn-labeled-right bg-blue heading-btn">
                        <b><i class="icon-add"></i></b>
                        {{ $t('admin.faq.index.header_btn') }}
                    </a>
                </div>
                <div class="col col-md-5">
                    <input
                        ...
                        type="text"
                        class="form-control"
                        :placeholder="$t('admin.faq.index.filters.search')"
                    >
                </div>
            ...
            <div class="table-responsive">
                <table class="table" id="bookings">
                    <thead>
                        <tr class="bg-blue">
                            <th>
                                {{ $t('admin.faq.index.table.headers.id') }}
                                <span>
                                    <i
                            ...
                            <th>
                                {{ $t('admin.faq.index.table.headers.name') }}
                                <span>
                                    <i
                            ...
                            <th>
                                {{ $t('admin.faq.index.table.headers.created_at') }}
                                <span>
                                    <i
                    ...
                    <tbody>
                        <template v-if="!isLoading">
                            <tr v-for="(faq, i) in faqs" :key="`faq_${i}`">
                                    <td><a :href="$r('admin.faq.edit', { faq: faq.id })">{{ faq.id }}</a></td>
                                    <td v-html="highlightSearchResult(faq.name, filters.search)"></td>
                                    <td>{{ faq.created_at }}</td>
                                    <td>
                                        <a :href="$r('admin.faq.edit', { faq: faq.id })">
                                            <i class="icon-pencil"></i>
                                        </a>
                                        <delete-confirmation
                                            :route-path="$r('admin.faq.delete', { faq: faq.id })"
                                            :redirect-path="$r('admin.faq.index')"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.debouncedGetFaqs =_.debounce(this.getFaqs, 500);
        },
    };
</script>
