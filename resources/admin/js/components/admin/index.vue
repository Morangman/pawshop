        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col col-auto">
                    <a :href="$r('admin.admin.create')" class="btn btn-labeled btn-labeled-right bg-blue heading-btn">
                ...
                <table class="table" id="bookings">
                    <thead>
                        <tr class="bg-blue">
                            ...
                            <th>{{ $t('admin.user.index.table.headers.last_accessed_at') }}</th>
                            <th>
                    ...
                    <tbody>
                        <template v-if="!isLoading">
                            <tr v-for="(user, i) in users" :key="`user_${i}`">
                                    <td><a :href="$r('admin.admin.edit', { user: user.id })">{{ user.id }}</a></td>
                                    ...
                                    <td>{{ user.last_accessed_at }}</td>
                                    <td>{{ user.created_at }}</td>
                                    <td>
                                        <a :href="$r('admin.admin.edit', { user: user.id })">
                                            <i class="icon-pencil"></i>
                                        </a>
                                        <delete-confirmation
                                            :route-path="$r('admin.admin.delete', { user: user.id })"
                                            :redirect-path="$r('admin.admin.index')"
