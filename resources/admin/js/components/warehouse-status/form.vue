            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        <label>
                            <strong>{{ $t('admin.warehouse-status.form.name') }}</strong>
                        </label>
                        <input
                            name="name"
                            type="text"
                    ...
                    <div class="form-group">
                        <label>
                            <strong>{{ $t('admin.warehouse-status.form.color') }}</strong>
                        </label>
                        <v-swatches
                            v-model="model.color"
                            popover-x="left"
                    ...
                    <div class="form-group">
                        <label>
                            <strong>{{ $t('admin.warehouse-status.form.order') }}</strong>
                        </label>
                        <input
                            name="order"
                            type="text"
            ...
            <div class="text-right">
                <template v-if="model.id">
                    <button
                        ...
                        @click.prevent="deleteWarehouseStatus"
                    >
